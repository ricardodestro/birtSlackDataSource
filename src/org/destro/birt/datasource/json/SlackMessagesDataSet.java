 ...
 * @author destro
 */
public class SlackMessagesDataSet {

	private static final String jsonUrl = "https://slack.com/api/channels.history";

	private Iterator<?> iterator;

	public List<SlackMessageVO> getMessages(String token, String channel, int count, long days) throws Exception {

		List<SlackMessageVO> list = new ArrayList<>();
		...
		jo.forEach(action -> {
			...
			SlackMessageVO vo = new SlackMessageVO(type, user, text, date);
